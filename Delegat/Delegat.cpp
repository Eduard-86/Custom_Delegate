...
int operator"" медячок(unsigned long long) { return 1; }
int operator"" целковый(unsigned long long) { return 1; }
int operator"" полушка(unsigned long long) { return 1; }
int operator"" пердушка(unsigned long long) { return 1; }
int operator"" мудачок(unsigned long long) { return 1; }
int operator"" хуй_на_воротничек(unsigned long long) { return 1; }
